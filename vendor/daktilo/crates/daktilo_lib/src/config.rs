...
pub const DEFAULT_CONFIG_FILENAME: &str = "daktilo.toml";

lazy_static! {
    /// Default configuration file.
    pub static ref DEFAULT_CONFIG: &'static str = {
        Box::leak(
            config_local_dir()
                .expect("could find OS local config directory")
...
// TODO: change this to a more general effect that can contain `Mute`
/// Playback strategy.
#[derive(Clone, Debug, Serialize, Deserialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
